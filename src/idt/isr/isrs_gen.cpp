...
{
    idt_set_gate(0, ISR0, GDT_CODE_SEGMENT, idt_flag_ring0 | idt_flag_gate_32bit_int); // populate the idt with the stubs. The stubs will call ISR_Handler - which is a general purpose handler
